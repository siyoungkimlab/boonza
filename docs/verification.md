...
| Martini 2 (the files boonza carries) | GROMACS 2024.6 `mdrun -rerun` | a bilayer of 128 DPPC (1536 beads) read from a `martini_v2.2.itp` + `martini_v2.0_lipids_all_201506.itp` topology: bond 421.644, G96 angle 435.416, LJ −28536.0 and Coulomb (the three reaction-field tables summed) −1081.11, potential −28760.11 against GROMACS's −28760.1 kJ/mol |
